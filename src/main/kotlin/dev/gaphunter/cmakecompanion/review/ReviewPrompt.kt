package dev.gaphunter.cmakecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.cmakecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.cmakecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "CMake Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33339-cmake-companion/reviews"
